...
contract RNGBlockhash is IRNG, Ownable {
    ...
    function requestRandomNumber() external virtual override returns (uint32, uint32) {
    ...
    function isRequestComplete(uint32 requestId) external view virtual override returns (bool isCompleted) {
    ...
    function randomNumber(uint32 requestId) external virtual override returns (uint256 randomNum) {
        ...
        emit RandomNumberGetted(randomNumbers[requestId]);
